...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'game','false',null,'USERNAME','PASSWORD';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_DEFINEDB','false',null,'USERNAME','PASSWORD';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_NCASH','false',null,'USERNAME','PASSWORD';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_USERDB','false',null,'USERNAME','PASSWORD';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_GAMEDB01','false',null,'USERNAME','PASSWORD';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_USERDB01','false',null,'USERNAME','PASSWORD';
END
